...
from .DeiT import deit_base_patch16_224 as deit_b
...
class TransFuse_S(nn.Module):
    def __init__(self,
        ...
        if pretrained:
            self.resnet.load_state_dict(
                torch.load(
                    '/raid/wjc/code/xbound_former/lib/TransFuse/pretrained/resnet34-43635321.pth'
                ))
        ...
        self.up_c = BiFusion_block(ch_1=256,
                                   ch_2=384,
                                   r_2=4,
                                   ch_int=256,
                                   ch_out=256,
        ...
        self.up_c_1_1 = BiFusion_block(ch_1=128,
                                       ch_2=128,
                                       r_2=2,
                                       ch_int=128,
                                       ch_out=128,
        ...
        self.up_c_2_1 = BiFusion_block(ch_1=64,
                                       ch_2=64,
                                       r_2=1,
                                       ch_int=64,
                                       ch_out=64,
    ...
    def forward(self, imgs, labels=None):
        ...
        x_b = x_b.view(x_b.shape[0], -1,
                       imgs.size(2) // 16,
                       imgs.size(3) // 16)  # (x_b.shape[0], -1, 12, 16)
        x_b = self.drop(x_b)
        ...
        x_c_2 = self.up_c_2_2(x_c_1,
                              x_c_2_1)  # joint predict low supervise here

        # decoder part
        map_x = F.interpolate(self.final_x(x_c),
                              scale_factor=16,
                              mode='bilinear')
        map_1 = F.interpolate(self.final_1(x_b_2),
                              scale_factor=4,
                              mode='bilinear')
        map_2 = F.interpolate(self.final_2(x_c_2),
                              scale_factor=4,
                              mode='bilinear')
...
class TransFuse_L(nn.Module):
    def __init__(self,
        ...
        if pretrained:
            self.resnet.load_state_dict(
                torch.load(
                    '/home/chenfei/.cache/torch/hub/checkpoints/resnet50-19c8e357.pth'
                ))
        self.resnet.fc = nn.Identity()
        self.resnet.layer4 = nn.Identity()
        ...
        self.up_c = BiFusion_block(ch_1=1024,
                                   ch_2=768,
                                   r_2=4,
                                   ch_int=1024,
                                   ch_out=1024,
        ...
        self.up_c_1_1 = BiFusion_block(ch_1=512,
                                       ch_2=512,
                                       r_2=2,
                                       ch_int=512,
                                       ch_out=512,
        ...
        self.up_c_2_1 = BiFusion_block(ch_1=256,
                                       ch_2=256,
                                       r_2=1,
                                       ch_int=256,
                                       ch_out=256,
    ...
    def forward(self, imgs, labels=None):
        ...
        x_b = self.transformer(imgs)
        x_b = torch.transpose(x_b, 1, 2)
        x_b = x_b.view(x_b.shape[0], -1, 32, 32)  # (x_b.shape[0], -1, 12, 16)
        x_b = self.drop(x_b)
