...
from lib.modules import xboundlearner
from lib.vision_transformers import in_scale_transformer

from lib.pvtv2 import pvt_v2_b2  #


def _segm_pvtv2(num_classes, im_num, ex_num, xbound):
    backbone = pvt_v2_b2()
...
class _simple_classifier(nn.Module):
    def __init__(self, num_classes):
        ...
        self.classifier = nn.Sequential(
            nn.Conv2d(576, 256, 3, padding=1, bias=False),  #560
            nn.BatchNorm2d(256),
...
class _bound_learner(nn.Module):
    ...
    def forward(self, x):
        ...
        # ''' point map Upsample '''
        features_encoded_3_1 = self.cross_attention_3_1(
            features_encoded_3, latent_tensor_1)
        features_encoded_3_2 = self.cross_attention_3_2(
            features_encoded_3, latent_tensor_2)
        ...
        if self.point_pred == 1:
            return x, point_maps_1, point_maps_2, point_maps_3  #
        else:
